...
assert(index.includes('infinite-score.css?v=0.3.19'), 'CSS cache bust was not updated');
assert(index.includes('infinite_score.js?v=0.3.41'), 'bag markup cache bust was not updated');
