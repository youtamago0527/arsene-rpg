...
(() => {
  ...
  const TRACKS = [
    ...
    {
      id: 'reprise-red-fox', no: '03', title: '赤狐の怪盗', bpm: '—', length: '3:53',
    ...
    {
      id: 'staccato-phantom-letter', no: '04', title: 'Qの予告状 -Phantom Letter “Q”-', bpm: '—', length: '3:28',
    ...
    {
      id: 'ostinato-labyrinth', no: '05', title: '月影の迷宮 -Labyrinth-', bpm: '—', length: '4:26',
