...
(() => {
  ...
  const d3 = name => `assets/enemy-characters/dungeon3/${name}.png`;
  ...
  const ENEMIES = {
    severKite: {
      ...
      sprite: d3('chainReaper'), battleScale: 1.0, sparkLevel: 27,
    ...
    mirrorGuard: {
      ...
      sprite: d3('fortressGolem'), battleScale: 1.25, sparkLevel: 28,
    ...
    staccatoChanter: {
      ...
      sprite: d4art('lanternMask'), battleScale: 1.05, sparkLevel: 29,
    ...
    graveMetronome: {
      ...
      sprite: d3('voidAlchemist'), battleScale: 1.0, sparkLevel: 30,
    ...
    afterimageStalker: {
      ...
      sprite: d3('riftAssailant'), battleScale: 1.05, sparkLevel: 31,
    ...
    severedChoir: {
      ...
      sprite: d3('voidOrchestra'), battleScale: 1.12, sparkLevel: 32,
    ...
    instantExecutioner: {
      ...
      sprite: d4art('mapleOni'), battleScale: 1.1, sparkLevel: 33,
    ...
    edgeColossus: {
      ...
      sprite: d3('crimsonBehemoth'), battleScale: 1.3, sparkLevel: 34,
    ...
    severanceHoarder: {
      ...
      sprite: d4art('toriiFox'), battleScale: 1.0, sparkLevel: 36,
