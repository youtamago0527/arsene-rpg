...
//
// 能力値は既存D4の水準（release_content.js側で+20%底上げ済みの値）へ合わせてある。
...
(() => {
  ...
  const ENEMIES = {
    severKite: {
      ...
      stats: { maxHp: 540, atk: 106, def: 58, mag: 34, mnd: 53, dex: 101, agi: 110, spd: 110 },
    ...
    mirrorGuard: {
      ...
      stats: { maxHp: 864, atk: 91, def: 125, mag: 26, mnd: 55, dex: 62, agi: 41, spd: 41 },
    ...
    staccatoChanter: {
      ...
      stats: { maxHp: 624, atk: 53, def: 72, mag: 115, mnd: 118, dex: 89, agi: 65, spd: 65 },
    ...
    graveMetronome: {
      ...
      stats: { maxHp: 672, atk: 62, def: 86, mag: 94, mnd: 103, dex: 82, agi: 62, spd: 62 },
    ...
    afterimageStalker: {
      ...
      stats: { maxHp: 516, atk: 113, def: 53, mag: 38, mnd: 48, dex: 106, agi: 118, spd: 118 },
    ...
    severedChoir: {
      ...
      stats: { maxHp: 960, atk: 70, def: 94, mag: 108, mnd: 89, dex: 79, agi: 55, spd: 55 },
    ...
    instantExecutioner: {
      ...
      stats: { maxHp: 708, atk: 139, def: 82, mag: 43, mnd: 60, dex: 86, agi: 74, spd: 74 },
    ...
    edgeColossus: {
      ...
      stats: { maxHp: 1140, atk: 122, def: 118, mag: 50, mnd: 72, dex: 70, agi: 38, spd: 38 },
    ...
    severanceHoarder: {
      ...
      stats: { maxHp: 408, atk: 72, def: 98, mag: 48, mnd: 84, dex: 115, agi: 139, spd: 139 },
