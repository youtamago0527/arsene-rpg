...
(() => {
  ...
  P.isRenderExplore = function (panel) {
    ...
    panel.innerHTML=`<main class="is-explore-screen" style="--is-explore-bg:url('../${bg}')">
      ...
      ${this.isStairHtml()}
      <span class="is-explore-character" role="img" aria-label="${name}" style="--is-character-image:url(&quot;${portrait}&quot;);--is-character-size:${portraitSize};--is-character-position:${portraitPosition}"></span>
