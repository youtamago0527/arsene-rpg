...
(() => {
  ...
  P.isRenderShop=function(panel,merchant=false){
    const r=this.isRun(),returnUnlocked=r.floor>=Math.max(1,Number(this.isEffectiveCfg().returnMinFloor)||20),hasReturn=returnUnlocked&&merchant&&this.isRand()<.12;
    ...
    const stock=[
      ...
      r.floor>=30?product('owPotion40','異界回復薬・中級','HP 40%',65,'＋'):null,r.floor>=30?product('owManaPotion40','異界魔力回復薬・中級','MP 40%',75,'✦'):null,
      r.floor>=60?product('owPotion60','異界回復薬・高級','HP 60%',125,'＋'):null,r.floor>=60?product('owManaPotion60','異界魔力回復薬・高級','MP 60%',140,'✦'):null,
