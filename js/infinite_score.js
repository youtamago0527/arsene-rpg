...
(() => {
  ...
  P.isRenderShop=function(panel,merchant=false){
    ...
    const stock=[product('potion','回復薬','HEAL POTION',25,'＋'),product('manaPotion','MP薬','MANA POTION',35,'✦'),product('gear','ランダム装備','MYSTERY GEAR',80,'?'),hasReturn?product('infiniteReturn','RETURN','ESCAPE RELIC',180,'↩'):null].filter(Boolean).join('');
