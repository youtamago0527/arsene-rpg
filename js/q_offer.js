...
(function(){
  ...
  function state(g){
    ...
    if(s.dateKey!==DAY()){Object.assign(s,{dateKey:DAY(),auto2Uses:0,sweepUses:0,otherworldUses:0,restoreUses:0});}
    return s;
  }
