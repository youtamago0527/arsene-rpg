window.ARSENE_DATA = {
  ...
  jobs: {
    ...
    priest: {
      id: 'priest', name: '僧侶', nameEn: 'PRIEST', description: '回復とGOLD稼ぎに特化した支援職。攻撃手段をほとんど持たず、戦うより長く潜って持ち帰ることに向く。', signatureSkillId: 'heal', passiveUnlocks: { 1: 'p_tithe', 5: 'p_spirit', 10: 'p_healArt', 15: 'p_wardBarrier' }, traits: {}, growthStats: ['mnd', 'vit'], featureText: '獲得GOLD+60%と回復量+25%を持つ稼ぎ・支援職。攻撃技は持たず、戦闘は武器の性能に依存する。強い武器を仕上げれば雑魚周回はこなせる。',
