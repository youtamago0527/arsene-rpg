window.ARSENE_DATA = {
  ...
  jobs: {
    ...
    martialArtist: {
      id: 'martialArtist', name: '武道家', nameEn: 'MARTIAL ARTIST', description: '速度と多段攻撃でクリティカルを狙う。', signatureSkillId: 'gatheringQi', passiveUnlocks: { 5: 'p_gale', 10: 'p_vitalAim', 15: 'p_fortune' },
      ...
      skillUnlocks: { 1: 'burstFist', 5: 'stunningPalm', 9: 'shortPower', 13: 'tigerBreakFist' }
    },
    priest: {
  ...
  skills: {
    ...
    // ── 武道家：素手技ツリー ───────────────────────────────
    // 攻撃技は素手専用。集気法だけは武道家MASTER時にPHANTOM THIEFへ盗得できる。
    burstFist: { id: 'burstFist', name: 'ばくれつけん', nameEn: 'BURST FIST', source: 'job', jobId: 'martialArtist', unlockJobLevel: 1, type: 'ACTIVE', kind: 'physical', target: 'single', randomTarget: true, requiresBareFists: true, mp: 6, power: 0.5, hits: 4, agiScale: 0, powerText: '攻撃力×0.5×4回', effectText: '素手専用／生存敵からランダムに4回連続攻撃／各撃で個別会心判定', description: '目にも留まらぬ拳の連打を叩き込む。素手から繰り出す武道家の基本技。' },
    stunningPalm: { id: 'stunningPalm', name: '震撃', nameEn: 'STUNNING PALM', source: 'job', jobId: 'martialArtist', unlockJobLevel: 5, type: 'ACTIVE', kind: 'physical', target: 'single', requiresBareFists: true, mp: 4, power: 1.1, agiScale: 0, effect: { type: 'enemyStun', chance: .45, bossChance: .16, overdriveChance: .06, turns: 1 }, powerText: '攻撃性能×1.1', effectText: '素手専用／45%でスタン、BOSS16%・OVERDRIVE6%', description: '掌底から衝撃を通し、敵の動きを一瞬止める。強敵ほど耐性が高く、連続では決まりにくい。' },
    shortPower: { id: 'shortPower', name: '短勁', nameEn: 'SHORT POWER', source: 'job', jobId: 'martialArtist', unlockJobLevel: 9, type: 'ACTIVE', kind: 'physical', target: 'single', requiresBareFists: true, mp: 7, power: .85, ignoreDef: .50, agiScale: 0, effect: { type: 'enemyDefDown', rate: .10, turns: 3 }, powerText: '攻撃性能×0.85', effectText: '素手専用／DEF50%貫通＋DEF−10%を3ターン', description: '至近距離から力を内側へ通す。威力を抑える代わりに防御を貫き、後続の拳が通る隙を作る。' },
    tigerBreakFist: { id: 'tigerBreakFist', name: '猛虎破砕拳', nameEn: 'TIGER BREAK FIST', source: 'job', jobId: 'martialArtist', unlockJobLevel: 13, type: 'ACTIVE', kind: 'physical', target: 'single', requiresBareFists: true, mp: 10, power: 1.2, agiScale: 0, effect: { type: 'selfStrStackAfterHit', rate: .05, maxStacks: 5 }, powerText: '攻撃性能×1.2', effectText: '素手専用／命中後、戦闘中STR+5%（最大5段階・+25%）', description: '猛虎の踏み込みで敵を砕き、戦いの中で肉体を研ぎ澄ます。命中するたび、その戦闘中の力が高まる。' },
    gatheringQi: { id: 'gatheringQi', name: '集気法', nameEn: 'GATHERING QI', source: 'job', jobId: 'martialArtist', unlockJobLevel: 15, type: 'ACTIVE', kind: 'support', target: 'self', mp: 8, cooldown: 3, powerText: '精神×1.8＋最大HP8%', effect: { type: 'hpRecover', baseHeal: 0, spiritScaling: 1.8, maxHpRate: .08 }, effectText: '精神依存回復＋最大HP8%／CT3／武道家MASTER時に盗得可能', description: '呼吸を整え、体内の気を巡らせる回復法。精神を鍛えたPHANTOM THIEFなら、さらに高い効果を引き出せる。' },
