(() => {
  ...
  Object.assign(D.musicScores, {
    ...
    ostinato: { id: 'ostinato', title: 'OSTINATO', subtitle: '月影の迷宮', artist: 'OSTINA', use: 'privateMode', unlockBoss: 'ostina', releaseFlag: 'd5Released', description: 'オスティナから盗み出す、月影の迷宮を執拗な反復で巡る楽曲。プライベートモードで演奏可能。', ...DEV },
