(() => {
  ...
  Object.assign(D.enemies, {
    ...
    d4MidBoss: enemy('d4MidBoss', '断刻の門番', 'dungeon4', 'assets/enemy-characters/dungeon4/d4MidBoss.png', { maxHp: 8160, atk: 158, def: 142, mag: 110, mnd: 127, dex: 139, agi: 110, spd: 110 }, 760, { min: 420, max: 560 }, [{ itemId: 'flashSteel', chance: 1 }, { itemId: 'moonEdgeOre', chance: .8 }], [{ id: 'attack', name: '断刻斬', kind: 'physical', weight: .55 }, { id: 'soulBolt', name: '時喰い', kind: 'magic', weight: .45 }], { kind: 'boss', bossRank: 'midBoss', title: '《断刻の門番》', role: 'MID BOSS / SPEED CHECK' }),
    astact: enemy('astact', 'アスタクト', 'dungeon4', 'assets/enemy-characters/dungeon4/astact.png', { maxHp: 15840, atk: 202, def: 158, mag: 125, mnd: 142, dex: 194, agi: 185, spd: 185 }, 1700, { min: 1150, max: 1450 }, [{ itemId: 'moonEdgeOre', chance: 1 }, { itemId: 'flashSteel', chance: 1 }], [{ id: 'attack', name: 'STACCATO', kind: 'physical', weight: .48 }, { id: 'ratBite', name: '瞬断連刃', kind: 'physical', weight: .32 }, { id: 'soulBolt', name: '残響断ち', kind: 'magic', weight: .20 }], { kind: 'boss', bossRank: 'dungeonBoss', title: '第四奏卿《瞬断の奏刃》', role: 'BOSS / SPEED & COUNTER', battleScale: 1.18, music: '音楽系/戦闘用/アスタクトのテーマ.mp3' }),
