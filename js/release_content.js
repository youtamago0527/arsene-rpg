(() => {
  ...
  Object.assign(D.enemies, {
    ...
    d4MidBoss: enemy('d4MidBoss', '断刻の門番', 'dungeon4', 'assets/enemy-characters/dungeon4/d4MidBoss.png', { maxHp: 16320, atk: 316, def: 284, mag: 220, mnd: 254, dex: 278, agi: 220, spd: 220 }, 760, { min: 420, max: 560 }, [{ itemId: 'flashSteel', chance: 1 }, { itemId: 'moonEdgeOre', chance: .8 }], [{ id: 'attack', name: '断刻斬', kind: 'physical', weight: .55 }, { id: 'soulBolt', name: '時喰い', kind: 'magic', weight: .45 }], { kind: 'boss', bossRank: 'midBoss', title: '《断刻の門番》', role: 'MID BOSS / SPEED CHECK' }),
    astact: enemy('astact', 'アスタクト', 'dungeon4', 'assets/enemy-characters/dungeon4/astact.png', { maxHp: 31680, atk: 404, def: 316, mag: 250, mnd: 284, dex: 388, agi: 370, spd: 370 }, 1700, { min: 1150, max: 1450 }, [{ itemId: 'moonEdgeOre', chance: 1 }, { itemId: 'flashSteel', chance: 1 }], [{ id: 'attack', name: 'STACCATO', kind: 'physical', weight: .48 }, { id: 'ratBite', name: '瞬断連刃', kind: 'physical', weight: .32 }, { id: 'soulBolt', name: '残響断ち', kind: 'magic', weight: .20 }], { kind: 'boss', bossRank: 'dungeonBoss', title: '第四奏卿《瞬断の奏刃》', role: 'BOSS / SPEED & COUNTER', battleScale: 1.18, music: '音楽系/戦闘用/アスタクトのテーマ.mp3' }),
    ...
    d5MidBoss: enemy('d5MidBoss', '毒律の追跡者', 'dungeon5', D.enemies.crimsonBehemoth.sprite, { maxHp: 33000, atk: 560, def: 500, mag: 580, mnd: 520, dex: 420, agi: 264, spd: 264 }, 1100, { min: 680, max: 880 }, [{ itemId: 'hunterThread', chance: 1 }, { itemId: 'venomCore', chance: .8 }], [{ id: 'attack', name: '追猟', kind: 'physical', weight: .5 }, { id: 'soulBolt', name: '毒律', kind: 'magic', weight: .5 }], { kind: 'boss', bossRank: 'midBoss', title: '《毒律の追跡者》', role: 'MID BOSS / ATTRITION' }),
    ostina: enemy('ostina', 'オスティナ', 'dungeon5', D.enemies.shatteredDiva.sprite, { maxHp: 63360, atk: 700, def: 620, mag: 730, mnd: 640, dex: 500, agi: 320, spd: 320 }, 2400, { min: 1650, max: 2100 }, [{ itemId: 'venomCore', chance: 1 }, { itemId: 'hunterThread', chance: 1 }], [{ id: 'soulBolt', name: 'OSTINATO', kind: 'magic', weight: .48 }, { id: 'attack', name: '狩律射', kind: 'physical', weight: .32 }, { id: 'shadowBolt', name: '反復毒奏', kind: 'magic', weight: .20 }], { kind: 'boss', bossRank: 'dungeonBoss', title: '第五奏卿《反復の狩律》', role: 'BOSS / DOT & DEBUFF', battleScale: 1.2 })
  });
