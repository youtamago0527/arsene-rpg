(() => {
  ...
  Object.assign(D.enemies, {
    flashHound: enemy('flashHound', '瞬きの猟犬', 'dungeon4', 'assets/enemy-characters/dungeon4/flashHound.png', { maxHp: 470, atk: 82, def: 54, mag: 38, mnd: 46, dex: 78, agi: 82, spd: 82 }, 180, { min: 90, max: 135 }, [{ itemId: 'flashSteel', chance: .55 }], [{ id: 'attack', name: '閃牙', kind: 'physical', weight: .7 }, { id: 'ratBite', name: '二連閃', kind: 'physical', weight: .3 }]),
    moonEdgeKnight: enemy('moonEdgeKnight', '月刃の騎士', 'dungeon4', 'assets/enemy-characters/dungeon4/moonEdgeKnight.png', { maxHp: 610, atk: 90, def: 72, mag: 44, mnd: 58, dex: 68, agi: 58, spd: 58 }, 210, { min: 110, max: 155 }, [{ itemId: 'moonEdgeOre', chance: .48 }, { itemId: 'flashSteel', chance: .24 }], [{ id: 'clubSmash', name: '月断ち', kind: 'physical', weight: .65 }, { id: 'attack', name: '構え斬り', kind: 'physical', weight: .35 }]),
    mapleOni: enemy('mapleOni', '紅葉鎧鬼', 'dungeon4', 'assets/enemy-characters/dungeon4/mapleOni.png', { maxHp: 560, atk: 96, def: 66, mag: 32, mnd: 42, dex: 62, agi: 48, spd: 48 }, 225, { min: 115, max: 165 }, [{ itemId: 'flashSteel', chance: .42 }, { itemId: 'moonEdgeOre', chance: .16 }], [{ id: 'attack', name: '紅刃斬', kind: 'physical', weight: .7 }, { id: 'clubSmash', name: '鎧打ち', kind: 'physical', weight: .3 }]),
    lanternMask: enemy('lanternMask', '三面灯籠', 'dungeon4', 'assets/enemy-characters/dungeon4/lanternMask.png', { maxHp: 430, atk: 58, def: 48, mag: 102, mnd: 76, dex: 74, agi: 68, spd: 68 }, 220, { min: 105, max: 150 }, [{ itemId: 'moonEdgeOre', chance: .38 }, { itemId: 'flashSteel', chance: .12 }], [{ id: 'soulBolt', name: '鬼火廻り', kind: 'magic', weight: .7 }, { id: 'attack', name: '灯突き', kind: 'physical', weight: .3 }]),
    toriiFox: enemy('toriiFox', '鳥居石狐', 'dungeon4', 'assets/enemy-characters/dungeon4/toriiFox.png', { maxHp: 500, atk: 78, def: 58, mag: 58, mnd: 68, dex: 92, agi: 88, spd: 88 }, 235, { min: 120, max: 175 }, [{ itemId: 'flashSteel', chance: .34 }, { itemId: 'moonEdgeOre', chance: .22 }], [{ id: 'ratBite', name: '石狐連爪', kind: 'physical', weight: .6 }, { id: 'soulBolt', name: '狐火', kind: 'magic', weight: .4 }]),
    d4MidBoss: enemy('d4MidBoss', '断刻の門番', 'dungeon4', 'assets/enemy-characters/dungeon4/d4MidBoss.png', { maxHp: 6800, atk: 132, def: 118, mag: 92, mnd: 106, dex: 116, agi: 92, spd: 92 }, 760, { min: 420, max: 560 }, [{ itemId: 'flashSteel', chance: 1 }, { itemId: 'moonEdgeOre', chance: .8 }], [{ id: 'attack', name: '断刻斬', kind: 'physical', weight: .55 }, { id: 'soulBolt', name: '時喰い', kind: 'magic', weight: .45 }], { kind: 'boss', bossRank: 'midBoss', title: '《断刻の門番》', role: 'MID BOSS / SPEED CHECK' }),
    astact: enemy('astact', 'アスタクト', 'dungeon4', 'assets/enemy-characters/dungeon4/astact.png', { maxHp: 13200, atk: 168, def: 132, mag: 104, mnd: 118, dex: 162, agi: 154, spd: 154 }, 1700, { min: 1150, max: 1450 }, [{ itemId: 'moonEdgeOre', chance: 1 }, { itemId: 'flashSteel', chance: 1 }], [{ id: 'attack', name: 'STACCATO', kind: 'physical', weight: .48 }, { id: 'ratBite', name: '瞬断連刃', kind: 'physical', weight: .32 }, { id: 'soulBolt', name: '残響断ち', kind: 'magic', weight: .20 }], { kind: 'boss', bossRank: 'dungeonBoss', title: '第四奏卿《瞬断の奏刃》', role: 'BOSS / SPEED & COUNTER', battleScale: 1.18 }),
