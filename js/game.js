  ...
  class BattleGame {
    ...
    */
    ...
    async defeat() {
      ...
      this.flashTitle('GAME OVER', 'MISSION FAILED'); await this.battleSleep(1000); this.showResult('GAME OVER', 'カズに救助され、HP 1で拠点へ運び込まれた。', 'RETURN TO HIDEOUT', `${this.battleSummaryHTML() || ''}<div class="q-after-defeat"><p>次の挑戦に備えて、Q’S OFFERを利用できます。</p><button data-q-offer="protect">保護のアルカナを受け取る<span>Q’S OFFER // 3秒</span></button></div>`);
    }
