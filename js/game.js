(() => {
  ...
  class BattleGame {
    ...
    itemTabs() {
      ...
      const typeNames = { sword: '剣', staff: '杖', dagger: '短剣', axe: '斧', spear: '槍', bow: '弓' };
      return {
